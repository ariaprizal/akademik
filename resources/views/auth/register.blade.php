            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('registers') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">Masukan NRP</label>

                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control @error('nrp') is-invalid @enderror" name="nrp" value="{{ old('nrp') }}" required autocomplete="nrp">
